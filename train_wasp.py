...
from model.wasp.multi_scale_ori_cond import *
...
full_dataset = CustomImageIdxDataset(root_dir='/data/jionkim/signal_dataset/npy_part_res_1024_dir_X')
# 전체 길이와 비율에 따라 분할
...
msresnet = MSResNet(input_channel=1, layers=[1, 1, 1, 1], condition_size=46)
...
for epoch in range(num_epochs):
    ...
    if epoch % 100 == 0:
        torch.save(msresnet, 'output/wasp/weight_epoch_' + str(epoch).zfill(4)  + '.pkl')
